<cfif structKeyExists(form,'fld_FormSubmit')>
  ...
  <cfinvoke component="tagCloud" method="addStringTask26">
    <cfinvokeargument name="userString" value="#variables.myfile#">   
  </cfinvoke>  
  <cfinvoke component="tagCloud" method="getStringTask26" returnvariable="getString"></cfinvoke>      
